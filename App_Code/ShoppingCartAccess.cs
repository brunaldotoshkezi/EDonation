...
public class ShoppingCartAccess
{
    ...
    private static string shportaId
    {
        get
        {
         ...
         //   if (context.Request.Cookies["Bamiresi_CartID"] == null) return "0";
           // string cartId = context.Request.Cookies["Bamiresi_CartID"].Value;
            // if the cart ID isn't in the cookie...
    
            {
                // check if the cart ID exists as a cookie
                if (context.Request.Cookies["Bamiresi_CartID"] != null)
                {
                    // return the id
                    string cartId = context.Request.Cookies["Bamiresi_CartID"].Value;
                    return cartId;
                ...
                // a new ID
                {
                    ...
                    HttpCookie cookie = new HttpCookie("Bamiresi_CartID", cartId);
                    // set the cookie's expiration date
                    int howManyDays = ecommerceConfiguration.CartPersistDays;
    ...
    public static bool ShtoNeShporte(string produktId, string atribute)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "ShtoNeShport";
        ...
        // create a new parameter
        param = comm.CreateParameter();
        param.ParameterName = "@Atribute";
        param.Value = atribute;
        param.DbType = DbType.String;
        comm.Parameters.Add(param);
    ...
    public static bool ModifikoNeShporte(string produktId, int sasia)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "UpdateShporta";
        // create a new parameter
        DbParameter param = comm.CreateParameter();
        param.ParameterName = "@Shporta_ID";
        param.Value = shportaId;
    ...
    public static bool FshiNgaShporta(string productId)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "HiqNgaShporta";
        // create a new parameter
        DbParameter param = comm.CreateParameter();
        param.ParameterName = "@Shporta_ID";
        param.Value = shportaId;
    ...
    public static DataTable MerrNgaShporta()
{
// get a configured DbCommand object
DbCommand comm = GenericDataAccess.CreateCommand();
// set the stored procedure name
comm.CommandText = "MerrNgaShporta";
// create a new parameter
DbParameter param = comm.CreateParameter();
param.ParameterName = "@Shporta_ID";
param.Value = shportaId;
...
return table;
    ...
    public static decimal ShumaTotale()
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "ShportaShumaTotale";
        // create a new parameter
        DbParameter param = comm.CreateParameter();
        param.ParameterName = "@Shporta_ID";
        param.Value = shportaId;
    ...
    public static int CountOldshporta(byte days)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "ShportaCountOldShportat";
        // create a new parameter
        DbParameter param = comm.CreateParameter();
    ...
    public static bool DeleteOldShporta(byte days)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "ShportaDeleteOldShportat";
        // create a new parameter
        DbParameter param = comm.CreateParameter();
        param.ParameterName = "@Days";
        param.Value = days;
    ...
    public static string KrijoOrder()
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "KrijoOrder";
        // create a new parameter
        DbParameter param = comm.CreateParameter();
        param.ParameterName = "@Shporta_ID";
        param.Value = shportaId;
    ...
    public static string KrijoCommerceLibOrder(int shippingId, int taxId)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name
        comm.CommandText = "KrijoKlientOrder";
        // create parameters
        DbParameter param = comm.CreateParameter();
        param.ParameterName = "@Shporta_ID";
        param.Value =  shportaId;
