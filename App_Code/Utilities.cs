...
SmtpClient(ecommerceConfiguration.MailServer, 587);
mailClient.EnableSsl = true;
    // Set credentials (for SMTP servers that require authentication)
mailClient.Credentials = new NetworkCredential(ecommerceConfiguration.MailUsername, ecommerceConfiguration.MailPassword);
...
if (ecommerceConfiguration.EnableErrorLogEmail)
{
    string from = ecommerceConfiguration.MailFrom;
