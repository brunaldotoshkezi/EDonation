...
namespace CommerceLib
{
    ...
    public class OrderProcessor
    {
        ...
        public void Process()
        {
            ...
            KrijoAudit("Order Processor started.", 10000);
            ...
            catch (OrderProcessorException ex)
            {
                ...
                KrijoAudit("Order Processing error occurred.", 10002);
            ...
            {
                CommerceLibAccess.KrijoAudit(Order.OrderID,
                  "Order Processor finished.", 10001);
            }
        }

        public void KrijoAudit(string message, int messageNumber)
        {
            CommerceLibAccess.KrijoAudit(Order.OrderID, message,
              messageNumber);
        }
