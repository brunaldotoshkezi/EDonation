...
<asp:Content ID="Content2" ContentPlaceHolderID="adminPlaceHolder" runat="Server">
  ...
  &nbsp;<asp:RangeValidator ID="startDateValidator" runat="server" ControlToValidate="startDateTextBox"
    Display="None" ErrorMessage="Invalid start date" MaximumValue="1/1/2018" MinimumValue="1/1/2009"
    Type="Date"></asp:RangeValidator>
  &nbsp;<asp:RangeValidator ID="endDateValidator" runat="server" ControlToValidate="endDateTextBox"
    Display="None" ErrorMessage="Invalid end date" MaximumValue="1/1/2018" MinimumValue="1/1/1999"
    Type="Date"></asp:RangeValidator>
  ...
  <asp:SqlDataSource ID="CustomerNameDS" runat="server" ConnectionString="<%$ ConnectionStrings:ecommerceConnection %>"
